        ...
        <Grid item>
          ...
          <Stack spacing={2} mt={3}>
            <Stack direction="row" alignItems="center" spacing={1}>
              ...
              <Typography>Bibliotecas na Nuvem Compartilhadas<br/><br/>
                Navegue até o painel Seu trabalho na barra lateral esquerda.<br/>
                Selecione a biblioteca que você deseja compartilhar.<br/>Selecione o
                ícone de Compartilhar<br/> no canto superior direito para
