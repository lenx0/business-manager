...
const Prices = () => {
  return (
    <Grid container backgroundColor="red" alignItems="center" justifyContent="space-between" textAlign="justify">
      <Grid item>
        <img src="../src/assets/images/illustration4.png" />
      </Grid>
      <Grid item>
        <Typography fontSize="60px">
          Selecione um nível de associação<br/>
          o preço certo para você.
        </Typography>
        <Typography>Preços listados em USD. Taxas não inclusas.<br/>
