...
const Prices = () => {
  return (
    ...
    >
      ...
      >
        <Grid item>
          <Card sx={{ maxWidth: 436, maxHeight: 644, margin: "auto", mt: 5, p: 4, borderRadius: 0 }}>
            <CardContent>
              ...
              <Grid container mt={20}justifyContent="center">
                <Button variant="contained" fullWidth color="primary" style={{ padding: 15, borderRadius: 0 }}>
                  Selecionar
                </Button>
              </Grid>
            </CardContent>
